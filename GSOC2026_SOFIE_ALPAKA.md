...
##### A Google Colab notebook for running the tests on a free T4 GPU is included in the SOFIE fork: `SOFIE_Alpaka_Exercise5_Test.ipynb` It contains the cell with test results done for Exercise 5.
---
