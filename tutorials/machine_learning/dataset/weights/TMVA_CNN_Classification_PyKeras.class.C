...
FilenameModel: "model_cnn.keras" [Filename of the initial Keras model]
FilenameTrainedModel: "trained_model_cnn.keras" [Filename of the trained output Keras model]
