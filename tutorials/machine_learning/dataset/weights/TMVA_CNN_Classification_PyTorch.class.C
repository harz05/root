...
UserCode: "/media/harsh/MyPassport1/root-build/tutorials/machine_learning/PyTorch_Generate_CNN_Model.py" [Necessary python code provided by the user to be executed before loading and training the PyTorch Model]
# Default:
