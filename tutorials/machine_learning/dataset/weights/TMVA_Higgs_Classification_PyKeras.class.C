...
FilenameModel: "Higgs_model.keras" [Filename of the initial Keras model]
FilenameTrainedModel: "Higgs_trained_model.keras" [Filename of the trained output Keras model]
